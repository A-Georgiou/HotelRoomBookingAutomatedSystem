...
public class HotelBookings2 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		final Scanner file = new Scanner(new FileReader("E://Data//Rooms.txt"));
	...
	private static void searchRooms() {
		...
		System.out.println("What is your preferred room type? Single/Double/Suite");
		roomType = input.next();
	...
	private static void reserveRoom() throws FileNotFoundException {
		PrintWriter Writer = new PrintWriter("E://Data//Rooms.txt");

		for (int i = 0; i < Rooms.length; i++) {
			Writer.println(Rooms[i].roomOrder());
	...
	private static void cancelRoom() {
		...
		if (cancelEmail.equalsIgnoreCase(eMail)) {
